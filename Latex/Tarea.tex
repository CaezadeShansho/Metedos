...
En el siguiente se informe se mostrarán y analizarán los resultados de los ejercicios entregados por el profesor, utilizando los métodos vistos en clases. Además, se indagará acerca del método de horner, describiendo el algoritmo, dando un par de ejemplos y mostrando su código.
