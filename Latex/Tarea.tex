...
En el siguiente se informe se mostrarán y analizarán los resultados
...
Resp: Al realizar el método de Newton aplicándolo a optimización, se obtiene un interes de 10.24\%. Considerando un error de 5\% el porcentaje era excesivamente alto, es por ello que se realizaron iteraciones hasta observar que el valor no cambiaba, así se encontro el valor en el que converge a los 10 años del préstamo.
...
\section{Resolución de sistemas de ecuaciones no lineales:}
    ...
    \begin{enumerate}   
        ...
        Pregunta $ 1a) $\\
            ...
            $ x*=[-1.60879;1.16860 ]$ siendo el punto  $x = -1.60879$,$y = 1.16860$
            ...
            $x*=[-2.40216;-1.60299]$ siendo el punto $x=-2.40216$, $y=-1.60299$
        ...
        Con el error pedido en el inicio de este item el programa no logra terminar en un tiempo razonable. debido a que el error es la condición de salida y que la diferencia  obtenida de una iteración con la otra nunca llega a ser tan pequeña como el intervalo a esperar. Para solucionar esto se redefine el margen de error a $10^-3$ 
        ...
        $ x*=[0.73994;0.47988] $ el punto $ x = 0.73994 $ , $ y = 0.47988$ con  $ error = 0.0007998437 $
        
        Luego calcularemos la solución que en el gráfico se encuentra en el 2do cuadrante utilizando el punto inicial $x0=[-1.8;0]$
        obteniendo como solución el vector $x*=[-1.66625;0.36118]$ el punto  $x=-1.66625$, $y=0.36118$ con $error  = 0.0002500395 $
   ...
   $$\begin{pmatrix}
    ...
    $$\begin{pmatrix}
        p_2 &=44.59016 \hspace{0.1cm} psi \\
        \\
        Q_1 &=15.94760 \\
        \\
        Q_2 &=8.11148
    \end{pmatrix}$$
    Por lo tanto como $Q = Q_1 + Q_2 $ implica que $ Q =24.05908 $
    
    Al igual que el ejercicio 1b) de éste item para lograr el objetivo de encontrar una raiz se limita a un margen de error menor al pedido, logrando así valores cercanos a la solución de la ecuación con condición de  error menor o igual a $10^-4$  logrando un error en la ultima iteración de : $ error = 0.0007513$
    
    Para realizar este item se utilizo el código de NewtonVariables.
