...
\end{figure}
Suponga ahora que desean endeudarse en 15 a~nos en lugar de 10. Cual sera el interes en esta situacion?
\\
Resp: 5.1\% . El proceso de su busqueda fue similar al anterior.
\\
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{fig_5a}
\end{figure}
\begin{itemize}
\item x0=0.5
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=9cm]{fig_5b}
\end{figure}
\begin{itemize}
\item x0=0.5
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=9cm]{5_g3_b}
\end{figure}
 \begin{itemize}
\item x0=0.5
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=9cm]{5_g4}
\end{figure}
 \begin{itemize}
\item x0=0.5
\end{itemize}
